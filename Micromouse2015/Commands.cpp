...
const Setter setList[] =
{
    ...
    {"th.kp", SETFLOAT(thetaController.kp)},
    {"th.ki", SETFLOAT(thetaController.ki)},
    {"th.kd", SETFLOAT(thetaController.kd)},
...
const Getter getList[] =
{
    ...
    {"cfront", GET(cfront)},
    {"ctheta", GET(ctheta)},
    {"th.kp", GET(thetaController.kp)},
    {"th.ki", GET(thetaController.ki)},
    {"th.kd", GET(thetaController.kd)},
